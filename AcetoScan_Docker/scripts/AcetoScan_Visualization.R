...
# Info
writeLines("Phylum Absolute abundance")
...
htmlwidgets::saveWidget(Phylum_Absolute_abundance_gg, "1_Phylum_abs_abundance.html")
...
htmlwidgets::saveWidget(barplot_phylum, "1_Phylum_barplot.html")

#####################################################################################################

# Info
writeLines("Class level")
...
# Info
writeLines("Family level heatmap")
...
# Info
writeLines("Genus level heatmap")
...
# Info
writeLines("Species level heatmap")
...
# Info
writeLines("Alpha diversity analysis")
...
# Info
writeLines("Phylogenetic tree visualization")
